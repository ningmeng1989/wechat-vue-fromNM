    ...
    <div class="_full_router component-chat-info">
        <div class="_full_inner">
            ...
            <div class="_cover-content _effect" :class="{'_effect--30':decline}">
                <div class="_full_scroll">
                    <!--群成员列表-->
                    <ul class="chat-dialogue-entry-collect">
                        <li v-for="item in chat_member" v-touch:tap="go_Info(item.id">
                            <div class="pic" :style="{backgroundImage:'url('+item.iconSrc+')'}"></div>
                    ...
                    <div class="weui_cells weui_cells_access">
                        ...
                        <a class="weui_cell" href="javascript:;">
                            <div class="weui_cell_hd weui_cell_primary">
                                <p>群公告</p>
                                <p class="_ellipsis-3" style="color:#888888;padding-right: 10px;max-height: 96px">
                                    迎接新的一天到来的不是别的迎接新的一天到来的不是别的迎接新的一天到来的不是别的迎接新的一天到来的不是别的,而是看!邮!件!
                                </p>
                            </div>
                            <div class="weui_cell_ft">
                            </div>
                    ...
                    <div class="weui_cells weui_cells_access">
                        <div class="weui_cell" href="javascript:;">
                            ...
                            <div class="weui_cell_ft">
                                <span class="_align-middle">杨涛-前端</span>
                            </div>
                        </div>
        ...
        <router-view transiton="cover"></router-view>
